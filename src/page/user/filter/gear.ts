...
const Gear = {
  render: async () => {
    ...
    <div class="container mx-auto grid 2xl:grid-cols-7 xl:grid-cols-5 lg:grid-cols-4 md:grid-cols-3 sm:grid-cols-2 gap-3 my-5">
      ${res.map((item: Product) => `
      <a href="/product/${item.id}">
            <div class="p-3 drop-shadow-md border rounded-md h-[450px]">
